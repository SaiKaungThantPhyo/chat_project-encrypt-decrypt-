			...
			<p>
				...
				<?php
					...
					else
					{
						...
						echo "<input type='password' id='text' placeholder='Enter decrypt key'>&nbsp;&nbsp;";
...
?>
  ...
  <form class="form-horizontal" method="post" action="sendMessage.php">
    <div class="form-group">
      <div class="col-sm-10">          
        <textarea name="msg" class="form-control" placeholder="Type your message here..."></textarea><br>
		<input type="password" name="password" placeholder="Type your secret key..." required>
      </div>
 ...
 <script>
         $(document).ready(function(){
             $(document).on('click','#btn', function(e){
					...
					//alert(v);
					$(this).closest("form").find("p[id='p']").html(v);
